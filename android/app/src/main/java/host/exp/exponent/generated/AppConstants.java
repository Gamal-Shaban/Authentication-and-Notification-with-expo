...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@shopz/notificatios";
  public static final String SHELL_APP_SCHEME = "exp7ec6ee1e4b7b4faeb0444718e3b056fa";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@jeemee442/notificatios", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40jeemee442%2Fnotificatios%2F1.0.0%2F84805f21956748f7cfd1d56c1ed2e8b7-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
